        ...
        <ul class="nav navbar-nav pull-right">
          ...
          <li class="dropdown, active">
              ...
              <ul class="dropdown-menu">
                  <li class="active"><a href="../dashboard.php ">Ultimos Pedidos de Accesorios</a></li>
          ...
          <div class="col-md-12">
            <fieldset>
              ...
              <div class="form-group">
                  ...
                  <input value ="<?php print $info_pedido['telefono'] ?>" type="tel" class="form-control" readonly>
              </div>
              <div class="form-group">
