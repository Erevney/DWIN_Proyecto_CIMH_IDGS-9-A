                ...
                <table class="table table-bordered">
                  ...
                  <tbody> 
                    <?php
                      ...
                      $info_category = $category->mostrar();

                    
                      $cantidad = count($info_category);
                      if($cantidad > 0){
                        $c=0;
                      for($x =0; $x < $cantidad; $x++){
                        $c++;
                        $item = $info_category[$x];
                    ?>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="../acciones3.php?id=<?php print $item['id'] ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
