        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class=active><a href="index.php.php" class="btn">Gestionar Usuario</a></li>
                </ul>
                <li class="dropdown">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody> 
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="../acciones4.php?id=<?php print $item['id'] ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
