  ...
  <body>
        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="../otros/index.php "> Otros</a></li>
                </ul>
                <li class="dropdown">
    ...
    <div class="container" id="main">
        ...
        <div class="row">
          <div class="col-md-12">
             <fieldset>
              <legend>Listado de Otros</legend>
                <table class="table table-bordered">
                  ...
                  <tbody> 
                    <?php
                      ...
                      $info_otro = $otro->mostrar();

                    
                      $cantidad = count($info_otro);
                      if($cantidad > 0){
                        $c=0;
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="../acciones2.php?id=<?php print $item['id'] ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
