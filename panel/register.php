    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="admins/index.php">Tienda Patitas</a>
        </div>
        ...
        <div class="main-login">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="text-center">Registrar Admin</h3>
                    </div>
...
<?php 
 if (isset($_POST['register'])) {
    ...
    $query = $connection->prepare("SELECT * FROM admins WHERE EMAIL=:email");
     ...
     if ($query->rowCount() == 0) {
         $query = $connection->prepare("INSERT INTO admins (USERNAME,PASSWORD,EMAIL) VALUES (:username,:password_hash,:email)");
