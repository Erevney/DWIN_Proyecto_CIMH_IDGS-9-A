...
<html lang="en">
  ...
  <body>
        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="../pedidos/index.php" class="btn">Todos los Pedidos de Accesorios</a></li>
    ...
    <div class="row">
          <div class="col-md-12">
             <fieldset>
              <legend>Listado de Pedidos de Otros</legend>
                  ...
                  <tbody> 
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="ver2.php?id=<?php print $item['id'] ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-eye-open"></span></a>
