...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $resultado = $otro->mostrarPorId($id);
    
    if(!$resultado)
       header('Location: otros.php');

    if(isset($_SESSION['carrito2'])){ //SI EL CARRITO EXISTE
        //SI EL ACCESORIO EXISTE EN EL CARRITO
        if(array_key_exists($id,$_SESSION['carrito2'])){
            actualizarOtro($id);
        }else{
            //  SI EL CARRITO NO EXISTE EN EL CARRITO
            agregarOtro($resultado, $id);
        }
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="active">
                <a href="carrito.php" class="btn"><span class="badge"><span class="glyphicon glyphicon-shopping-cart"></span><?php print cantidadOtros(); ?></span></a>
            </li>
            <li>
    ...
    <div class="container" id="main">
            <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                      ...
                      ?>
                        <tr>
                            <form action="actualizar_carrito2.php" method="post">
                                <td><?php print $c ?></td>
                                <td><?php print $value['nombre_otro']  ?></td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    ...
                                    <a href="eliminar_carrito2.php?id=<?php print $value['id']  ?>" class="btn btn-danger btn-xs">
                    ...
                    ?>
                        <tr>
                            <td colspan="7">No Hay Otros En El Carrito </td>
                        </tr>
                ...
                <tfoot>
                        <tr>
                            ...
                            <td><?php print calcularTotal2(); ?> MXN</td>
                            <td></td>
                        </tr>
            ...
            <div class="row">
                    <div class="pull-left">
                        <a href="otros.php" class="btn btn-info">Seguir Comprando</a>
                    </div>
      ...
      paypal.Buttons({
        ...
        createOrder: (data, actions) => {
          return actions.order.create({
            purchase_units: [{
              amount: {
                value: '<?php print calcularTotal2(); ?>' // Can also reference a variable or function
              }
            }]
          });
        },
